...
class EditarProgressoBottomSheet : BaseBottomSheetDialogFragment() {
    ...
    private fun editar(tarefa: TarefaEmProgresso) {
        setFragmentResult("tarefaProgresso", bundleOf("tarefaProgressoEditar" to tarefa))
        dismiss()
    }
