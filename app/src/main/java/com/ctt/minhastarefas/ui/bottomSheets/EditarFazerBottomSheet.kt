...
class EditarFazerBottomSheet : BaseBottomSheetDialogFragment() {
    ...
    private fun editar(tarefa: TarefaAFazer) {
        setFragmentResult("tarefaFazer", bundleOf("tarefaAfazerEditar" to tarefa))
